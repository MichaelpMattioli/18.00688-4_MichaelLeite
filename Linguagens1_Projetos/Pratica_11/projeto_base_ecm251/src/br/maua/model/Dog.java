...
public class Dog extends Animal {
    ...
    /**
     * Método implementado da inferface Eat, que descreve como o animal se alimenta.
     * @param amount Quantos kilos de comida nosso cachorro comeu
     * @return Uma String cokm as informações do nome do cachorro e a quantidade consumida de alimento, em kilogramas.
     */
    @Override
